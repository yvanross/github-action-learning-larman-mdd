...
<!-- .slide: data-background-color="#aaaaaa" -->
### Line chart from JSON string

<!-- Lots of configuring of chart.js here. Note that true/false values should not be quoted. -->
  ...
  "datasets":[
   {
    ...
    "backgroundColor": ["rgba(10,10,220,.8)"]
   },
   {
...
My first dataset, 65, 59, 80, 81, 56, 55, 40
My second dataset, 28, 48, 40, 19, 86, 27, 90
<!-- Good idea to make bar charts have the y-axis "beginAtZero" -->
<!--
{
    "options": { 
        "scales": {
...
{
"data" : {
"datasets" : [{ "backgroundColor": "rgba(255,100,100,0.8" }, { "backgroundColor": "rgba(100,255,100,0.8" } ]
},
